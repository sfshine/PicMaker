...
public class EleFileGridAdapter extends BaseAdapter {
	private LayoutInflater inflater;
	private List<PicFileBean> pictures;
	private Context context;
	private int imagethumb = 0;

	public EleFileGridAdapter(Context context, List<PicFileBean> pictures) {
		super();
	...
	@Override
	public int getCount() {
		return pictures.size() > Constant.ELECOUNTS ? Constant.ELECOUNTS
				: pictures.size();
